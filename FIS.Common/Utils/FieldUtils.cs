            ...
            switch (fieldInfo.FieldType)
            {
                ...
                case CODES.DEFMODFLD.FLDTYPE.DATETIME:
                    ...
                    catch
                    {
                        ...
                        return DateTime.Parse(string.Format(App.Environment.ClientInfo.Culture, "{0}", value), App.Environment.ClientInfo.Culture, System.Globalization.DateTimeStyles.AssumeLocal);
                        //return DateTime.Parse(string.Format(App.Environment.ClientInfo.Culture, "{0}", value), App.Environment.ClientInfo.Culture);
                    }
                default:
                    return value;
